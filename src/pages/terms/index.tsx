      ...
      <Layout>
        <div className="h-full w-full text-center">
          ...
          <div className="flex justify-center mb-6">
            <div className="columns-1 max-w-[1000px] lg:columns-2 gap-6 px-0 pr-5 lg:px-8">
              <div className="container">
                ...
                <br />
                <p>
                  We use some of Your Personal data to provide and improve the
                ...
                <ul className="list-disc pl-5">
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to joShare |
                      File Sharing.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      ...
                      Although besides your email we do not use your personal
                      data and that&apos;s also optional. You have to provide
                      your mail if you want to send any e-mail using our
                      service.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to joShare | File Sharing,
                      accessible from{" "}
                      <a
              ...
              <div className="container">
                ...
                <br />
                <p>
                  Generally we do not collect any personal data besides E-mail
                  address and that's also optional. You have to provide your
                  mail if you want to send any e-mail using our service. Even
                  your email information gets deleted after your PIN expires.
                </p>
                <br />
          ...
          <div className="flex flex-col items-center mb-2">
            ...
            <Link
              className="cursor-pointer hover:scale-110 transition-all duration-300 text-indigo-800 dark:text-indigo-400"
              href="mailto:support@joshare.xyz"
            >
              support@joshare.xyz
            </Link>
          </div>
