export default function Button({ 
    ...
    return (
        <button 
          onClick={onClick}
          disabled={loading}
          className={`button group flex justify-center items-center h-${height} w-${width}`}
        >
          {loading ? 
          (
            <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="24" height="22">
                <path className="fill-slate-900 group-hover:fill-slate-50 dark:fill-slate-50 dark:group-hover:fill-slate-900" d="M0 0h4v10H0z">
                ...
                <path className="fill-slate-900 group-hover:fill-slate-50 dark:fill-slate-50 dark:group-hover:fill-slate-900" d="M10 0h4v10h-4z">
                ...
                <path className="fill-slate-900 group-hover:fill-slate-50 dark:fill-slate-50 dark:group-hover:fill-slate-900" d="M20 0h4v10h-4z">
