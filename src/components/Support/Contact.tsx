...
export default function Contact() {
    ...
    return (
        ...
        <div className="mt-3 mb-8 flex flex-col gap-3 items-center text-lg">
            <div>
            <MdOutlineMarkEmailRead className="inline" /> : <a href="mailto:support@joshare.xyz" target='_blank'>support@joshare.xyz</a>
            </div>
            <div>
            <FiTwitter className="inline" /> : <a href="https://twitter.com/itsabdulkader" target='_blank'>Twitter</a>
            </div>
        </div>
