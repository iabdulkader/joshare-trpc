...
export default function AddTime() {
  ...
  for (var i = 0; i <= 24; i++) {
    options.push(
      <option
        className="bg-secondaryBg-light dark:bg-secondaryBg-dark"
        value={i}
        key={i}
      >
        {i === 0 ? "Select Time" : `${i} Hour`}
      </option>
    );
  }
  ...
  return (
    <div className="modal-container">
      ...
      <div className="mb-2 text-center text-xs">
        <p>
          Your files will be deleted autometically after 24 hours from creating
          your session. But You can extend this expiry time upto additional 48
          hours. To add time select how many hours you want to extend and click
          Add Time.
        </p>
      </div>
      ...
      <div className="mb-4">
        <p className="text-base">
          Attempts Remaining <span className="dot">{timeExtRemaining}</span>
        </p>
      </div>
